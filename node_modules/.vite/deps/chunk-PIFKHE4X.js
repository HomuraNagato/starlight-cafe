import {
  ReactiveValue
} from "./chunk-2KTMJLA7.js";
import {
  on
} from "./chunk-PSQ6PYWI.js";
import {
  active_reaction,
  get2 as get,
  increment,
...
import {
  ...
  __privateSet,
  __superGet
} from "./chunk-PU2ASUS5.js";

// node_modules/svelte/src/reactivity/date.js
var inited = false;
var _time, _deriveds, _reaction, _init, init_fn;
...
var inited2 = false;
var _sources, _version, _size, _update_version, _source, source_fn, _init2, init_fn2;
var _SvelteSet = class _SvelteSet extends Set {
  ...
  has(value) {
    ...
    if (s === void 0) {
      ...
      s = __privateMethod(this, _source, source_fn).call(this, true);
      if (true_default) {
...
var _sources2, _version2, _size2, _update_version2, _source2, source_fn2, _read_all, read_all_fn;
var _SvelteMap = class _SvelteMap extends Map {
  ...
  has(key) {
    ...
    if (s === void 0) {
      if (super.has(key)) {
        s = __privateMethod(this, _source2, source_fn2).call(this, 0);
        if (true_default) {
...
read_all_fn = function() {
  ...
  if (__privateGet(this, _size2).v !== sources.size) {
    for (var key of __superGet(_SvelteMap.prototype, this, "keys").call(this)) {
      if (!sources.has(key)) {
        var s = __privateMethod(this, _source2, source_fn2).call(this, 0);
        if (true_default) {
          tag(s, `SvelteMap get(${label(key)})`);
        }
        sources.set(key, s);
...
var SvelteURL = class extends URL {
  ...
  constructor(url, base) {
    ...
    __privateAdd(this, _searchParams, void 0);
    if (true_default) {
...
//# sourceMappingURL=chunk-PIFKHE4X.js.map
