...
function async_derived(fn, label2, location) {
  ...
  if (true_default)
    signal.label = label2 ?? fn.toString();
...
process_fn = function() {
  ...
  for (const root of roots) {
    try {
      __privateMethod(this, _traverse, traverse_fn).call(this, root, effects, render_effects);
    } catch (e) {
      reset_all(root);
    ...
    if (others.length === 0) {
      ...
      if (__privateGet(batch, _roots).length > 0 && !__privateGet(batch, _decrement_queued)) {
        ...
        for (var root of __privateGet(batch, _roots)) {
          __privateMethod(_a2 = batch, _traverse, traverse_fn).call(_a2, root, [], []);
        }
...
function eager(fn) {
  ...
  teardown(() => {
    if (parent.f & DESTROYING)
      version_map.delete(parent);
  });
  get(version);
  eager_effect(() => {
    if (initial) {
...
//# sourceMappingURL=chunk-Z7GNOZHR.js.map
