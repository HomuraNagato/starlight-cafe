...
var Crosshair = class extends DataSource {
  ...
  _internal_updateAllViews() {
    this._private__model._internal_panes().forEach((pane) => {
      var _a, _b;
      (_a = this._private__crosshairPaneViewCache.get(pane)) == null ? void 0 : _a._internal_update();
      (_b = this._private__markersPaneViewCache.get(pane)) == null ? void 0 : _b._internal_update();
    });
...
var HorizontalLineRenderer = class extends BitmapCoordinatesPaneRenderer {
  ...
  _internal_hitTest(x, y) {
    var _a;
    if (!((_a = this._private__data) == null ? void 0 : _a._internal_visible)) {
      return null;
    }
...
var PrimitiveRendererWrapper = class {
  ...
  _internal_drawBackground(target, isHovered, hitTestData) {
    var _a, _b;
    (_b = (_a = this._private__baseRenderer).drawBackground) == null ? void 0 : _b.call(_a, target, drawingUtils);
  }
};
var PrimitivePaneViewWrapper = class {
  ...
  _internal_renderer() {
    ...
    if (((_a = this._private__cache) == null ? void 0 : _a._internal_base) === baseRenderer) {
  ...
  _internal_zOrder() {
    var _a, _b;
    return ((_b = (_a = this._private__paneView).zOrder) == null ? void 0 : _b.call(_a)) ?? "normal";
  }
};
var PrimitiveWrapper = class {
  ...
  _internal_updateAllViews() {
    var _a, _b;
    (_b = (_a = this._internal__primitive).updateAllViews) == null ? void 0 : _b.call(_a);
  }
  _internal_paneViews() {
    var _a, _b, _c;
    const base = ((_b = (_a = this._internal__primitive).paneViews) == null ? void 0 : _b.call(_a)) ?? [];
    if (((_c = this._private__paneViewsCache) == null ? void 0 : _c._internal_base) === base) {
  ...
  _internal_hitTest(x, y) {
    var _a, _b;
    return ((_b = (_a = this._internal__primitive).hitTest) == null ? void 0 : _b.call(_a, x, y)) ?? null;
  }
};
...
function getAxisViewData(baseView) {
  ...
  return {
    ...
    _internal_fixedCoordinate: (_a = baseView.fixedCoordinate) == null ? void 0 : _a.call(baseView),
    _internal_color: baseView.textColor(),
    _internal_background: baseView.backColor(),
    _internal_visible: ((_b = baseView.visible) == null ? void 0 : _b.call(baseView)) ?? true,
    _internal_tickVisible: ((_c = baseView.tickVisible) == null ? void 0 : _c.call(baseView)) ?? true
  };
}
...
var SeriesPrimitiveWrapper = class extends PrimitiveWrapper {
  ...
  _internal_timeAxisViews() {
    var _a, _b, _c;
    const base = ((_b = (_a = this._internal__primitive).timeAxisViews) == null ? void 0 : _b.call(_a)) ?? [];
    if (((_c = this._private__timeAxisViewsCache) == null ? void 0 : _c._internal_base) === base) {
  ...
  _internal_priceAxisViews() {
    var _a, _b, _c;
    const base = ((_b = (_a = this._internal__primitive).priceAxisViews) == null ? void 0 : _b.call(_a)) ?? [];
    if (((_c = this._private__priceAxisViewsCache) == null ? void 0 : _c._internal_base) === base) {
  ...
  _internal_priceAxisPaneViews() {
    var _a, _b, _c;
    const base = ((_b = (_a = this._internal__primitive).priceAxisPaneViews) == null ? void 0 : _b.call(_a)) ?? [];
    if (((_c = this._private__priceAxisPaneViewsCache) == null ? void 0 : _c._internal_base) === base) {
  ...
  _internal_timeAxisPaneViews() {
    var _a, _b, _c;
    const base = ((_b = (_a = this._internal__primitive).timeAxisPaneViews) == null ? void 0 : _b.call(_a)) ?? [];
    if (((_c = this._private__timeAxisPaneViewsCache) == null ? void 0 : _c._internal_base) === base) {
  ...
  _internal_autoscaleInfo(startTimePoint, endTimePoint) {
    var _a, _b;
    return ((_b = (_a = this._internal__primitive).autoscaleInfo) == null ? void 0 : _b.call(_a, startTimePoint, endTimePoint)) ?? null;
  }
};
...
var Series = class extends PriceDataSource {
  ...
  _internal_updateAllViews() {
    ...
    (_a = this._private__lastPriceAnimationPaneView) == null ? void 0 : _a._internal_update();
  ...
  _private__autoscaleInfoImpl(startTimePoint, endTimePoint) {
    ...
    this._private__primitives.forEach((primitive) => {
      ...
      if (primitiveAutoscale == null ? void 0 : primitiveAutoscale.priceRange) {
      ...
      if (primitiveAutoscale == null ? void 0 : primitiveAutoscale.margins) {
  ...
  _private__precomputeConflationLevels(priority) {
    ...
    for (const lvl of conflateFactors) {
      ...
      if ((_a = globalObj == null ? void 0 : globalObj._internal_scheduler) == null ? void 0 : _a._internal_postTask) {
...
var Pane = class {
  ...
  _internal_orderedSourcesForRendering() {
    ...
    const hovered = (_a = this._private__model._internal_hoveredSource()) == null ? void 0 : _a._internal_source;
...
function findBestPrimitiveHitTest(sources, x, y) {
  ...
  let bestHitSource;
  for (const source of sources) {
    const primitiveHitResults = ((_a = source._internal_primitiveHitTest) == null ? void 0 : _a.call(source, x, y)) ?? [];
    for (const hitResult of primitiveHitResults) {
      const candidate = primitiveHitCandidate(hitResult);
      if (comparePrimitiveZOrder(hitResult.zOrder, bestPrimitiveHit == null ? void 0 : bestPrimitiveHit.zOrder) || hitResult.zOrder === (bestPrimitiveHit == null ? void 0 : bestPrimitiveHit.zOrder) && bestPrimitiveCandidate !== void 0 && isBetterHit(candidate, bestPrimitiveCandidate) || hitResult.zOrder === (bestPrimitiveHit == null ? void 0 : bestPrimitiveHit.zOrder) && bestPrimitiveCandidate === void 0) {
...
function hitTestPaneView(paneViews, x, y, pane) {
  ...
  for (const paneView of paneViews) {
    let candidate = ((_a = paneView._internal_hitTest) == null ? void 0 : _a.call(paneView, x, y, pane)) ?? null;
    if (candidate === null) {
...
function hitTestPane(pane, x, y) {
  ...
  if ((bestPrimitiveHit == null ? void 0 : bestPrimitiveHit._internal_hit.zOrder) === "top") {
  ...
  if (bestPrimitiveHit == null ? void 0 : bestPrimitiveHit._internal_hit) {
    return convertPrimitiveHitResult(bestPrimitiveHit);
  }
  return null;
}
...
var TimeScale = class {
  ...
  _internal_indexToTime(index) {
    var _a;
    return ((_a = this._private__points[index]) == null ? void 0 : _a.time) ?? null;
  }
...
var ChartModel = class {
  ...
  _internal_setHoveredSource(source) {
    ...
    if (((_a = this._private__hoveredSource) == null ? void 0 : _a._internal_source) === (source == null ? void 0 : source._internal_source) && ((_c = (_b = this._private__hoveredSource) == null ? void 0 : _b._internal_object) == null ? void 0 : _c._internal_externalId) === ((_d = source == null ? void 0 : source._internal_object) == null ? void 0 : _d._internal_externalId) && ((_f = (_e = this._private__hoveredSource) == null ? void 0 : _e._internal_object) == null ? void 0 : _f._internal_hitTestData) === ((_g = source == null ? void 0 : source._internal_object) == null ? void 0 : _g._internal_hitTestData) && ((_h = this._private__hoveredSource) == null ? void 0 : _h._internal_cursorStyle) === (source == null ? void 0 : source._internal_cursorStyle) && ((_i = this._private__hoveredSource) == null ? void 0 : _i._internal_itemType) === (source == null ? void 0 : source._internal_itemType)) {
      return;
    }
    ...
    if (source !== null && source._internal_source !== (prevSource == null ? void 0 : prevSource._internal_source)) {
...
function isWindows() {
  ...
  if ((_a = navigator == null ? void 0 : navigator.userAgentData) == null ? void 0 : _a.platform) {
...
function buildHoveredEventInfo(hoveredSource, paneIndex) {
  ...
  const hoveredObject = (_a = hoveredSource == null ? void 0 : hoveredSource._internal_object) == null ? void 0 : _a._internal_externalId;
...
function releaseCanvas(canvas) {
  ...
  canvas.width = 1;
  canvas.height = 1;
  (_a = canvas.getContext("2d")) == null ? void 0 : _a.clearRect(0, 0, 1, 1);
}
...
function buildPriceAxisViewsGetter(zOrder, priceScaleId) {
  return (source) => {
    ...
    const psId = ((_a = source._internal_priceScale()) == null ? void 0 : _a._internal_id()) ?? "";
    if (psId !== priceScaleId) {
      return [];
    }
    return ((_b = source._internal_pricePaneViews) == null ? void 0 : _b.call(source, zOrder)) ?? [];
  };
}
...
var PriceAxisWidget = class {
  ...
  _internal_update() {
    var _a;
    (_a = this._private__priceScale) == null ? void 0 : _a._internal_marks();
  }
...
function sourceBottomPaneViews$1(source, pane) {
  var _a;
  return ((_a = source._internal_bottomPaneViews) == null ? void 0 : _a.call(source, pane)) ?? [];
}
function sourcePaneViews$1(source, pane) {
  var _a;
  return ((_a = source._internal_paneViews) == null ? void 0 : _a.call(source, pane)) ?? [];
}
function sourceLabelPaneViews(source, pane) {
  var _a;
  return ((_a = source._internal_labelPaneViews) == null ? void 0 : _a.call(source, pane)) ?? [];
}
function sourceTopPaneViews$1(source, pane) {
  var _a;
  return ((_a = source._internal_topPaneViews) == null ? void 0 : _a.call(source, pane)) ?? [];
}
var PaneWidget = class _PaneWidget {
  ...
  _internal_setState(pane) {
    ...
    if (this._private__chart._internal_paneWidgets().indexOf(this) === this._private__chart._internal_paneWidgets().length - 1) {
      ...
      (_a = this._private__attributionLogoWidget) == null ? void 0 : _a._internal_removeElement();
      this._private__attributionLogoWidget = null;
    }
  }
  _internal_chart() {
...
function buildTimeAxisViewsGetter(zOrder) {
  return (source) => {
    var _a;
    return ((_a = source._internal_timePaneViews) == null ? void 0 : _a.call(source, zOrder)) ?? [];
  };
}
...
var ChartWidget = class {
  ...
  _internal_applyOptions(options) {
    ...
    if ((_a = options["layout"]) == null ? void 0 : _a.panes) {
  ...
  _private__drawImpl(invalidateMask, time) {
    ...
    if (invalidationType === 3 || invalidationType === 2) {
      ...
      if (((_a = this._private__invalidateMask) == null ? void 0 : _a._internal_fullInvalidation()) === 3) {
  ...
  _private__getMouseEventParamsImpl(index, point, event, pane) {
    ...
    let clientTime;
    if (index !== null) {
      const timePoint = (_a = this._private__model._internal_timeScale()._internal_indexToTimeScalePoint(index)) == null ? void 0 : _a.originalTime;
      if (timePoint !== void 0) {
  ...
  _private__onPaneWidgetCrosshairMoved(time, point, event) {
    var _a;
    this._internal_setCursorStyle(((_a = this._internal_model()._internal_hoveredSource()) == null ? void 0 : _a._internal_cursorStyle) ?? null);
...
var SeriesCustomPaneView = class extends SeriesPaneViewBase {
  ...
  _internal__hitTestImpl(x, y) {
    var _a, _b;
    const customHit = (_b = (_a = this._private__sourceRenderer).hitTest) == null ? void 0 : _b.call(_a, x, y, (price) => this._private__rendererPriceCoordinate(price));
...
var ChartApi = class {
  ...
  applyOptions(options) {
    var _a, _b;
    {
      const colorSpace = (_a = options.layout) == null ? void 0 : _a.colorSpace;
      ...
      const colorParsers = (_b = options.layout) == null ? void 0 : _b.colorParsers;
...
var YieldCurveHorzScaleBehavior = class {
  ...
  _private__formatTime(months) {
    var _a;
    if ((_a = this._private__options.localization) == null ? void 0 : _a.timeFormatter) {
...
var PaneRendererArea = class extends PaneRendererAreaBase {
  ...
  _internal__fillStyle(renderingScope, item) {
    ...
    return this._private__fillCache._internal_get(renderingScope, {
      ...
      _internal_topCoordinate: ((_a = this._internal__data) == null ? void 0 : _a._internal_topCoordinate) ?? 0,
...
var PanePrimitiveWrapper2 = class {
  ...
  applyOptions(options) {
    var _a, _b;
    (_b = (_a = this._private__primitive)._internal_applyOptions) == null ? void 0 : _b.call(_a, options);
  }
  _private__attach() {
...
function mergeOptionsWithDefaults$2(options) {
  ...
  return {
    ...
    ...options,
    lines: ((_a = options.lines) == null ? void 0 : _a.map(mergeLineOptionsWithDefaults)) ?? []
  };
}
...
var ImageWatermark = class {
  ...
  attached(attachedParams) {
    ...
    this._private__imgElement.onload = () => {
      var _a, _b;
      const imageHeight = ((_a = this._private__imgElement) == null ? void 0 : _a.naturalHeight) ?? 1;
      const imageWidth = ((_b = this._private__imgElement) == null ? void 0 : _b.naturalWidth) ?? 1;
...
var SeriesMarkersPrimitive = class {
  ...
  hitTest(x, y) {
    ...
    if (this._private__paneView) {
      return ((_a = this._private__paneView.renderer()) == null ? void 0 : _a._internal_hitTest(x, y)) ?? null;
    }
    return null;
  }
  ...
  _private__recalculateMarkers() {
    ...
    const timeScale = this._private__chart.timeScale();
    const seriesData = (_a = this._private__series) == null ? void 0 : _a.data();
...
var UpDownMarkersPrimitive = class {
  ...
  _internal_requestUpdate() {
    var _a;
    (_a = this._private__requestUpdate) == null ? void 0 : _a.call(this);
  }
  attached(params) {
